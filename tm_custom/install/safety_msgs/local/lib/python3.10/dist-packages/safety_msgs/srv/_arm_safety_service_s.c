...
bool safety_msgs__srv__arm_safety_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("safety_msgs.srv._arm_safety_service.ArmSafetyService_Request", full_classname_dest, 60) == 0);
  }
  safety_msgs__srv__ArmSafetyService_Request * ros_message = _ros_message;
  {  // motion_type
...
{
  /* NOTE(esteve): Call constructor of ArmSafetyService_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("safety_msgs.srv._arm_safety_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmSafetyService_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool safety_msgs__srv__arm_safety_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("safety_msgs.srv._arm_safety_service.ArmSafetyService_Response", full_classname_dest, 61) == 0);
  }
  safety_msgs__srv__ArmSafetyService_Response * ros_message = _ros_message;
  {  // ok
...
{
  /* NOTE(esteve): Call constructor of ArmSafetyService_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("safety_msgs.srv._arm_safety_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmSafetyService_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
